//
//  ZongHeBG_XiangXChX_XiaoShDT.swift
//  PetroChina.THYT.ZongHBG
//
//  Created by Mensp on 14/10/25.
//  Copyright (c) 2014年 PetroChina. All rights reserved.
//

import UIKit

class ZongHeBG_XiangXChX_XiaoShDT: UITableViewController,UIWebViewDelegate {

    //菊花
    var myview:UIView!
    var refresh = UIRefreshControl()//刷新
    @IBOutlet weak var wvXiangXChX_XiaoShDT: UIWebView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.wvXiangXChX_XiaoShDT.delegate = self
        //刷新
...
//        var url:NSURL = NSURL(string:"http://127.0.0.1:10024/DayReport/cyc_rb/xsdt/xsdt.jsp")!
        var url:NSURL = NSURL(string:xiaoshoudongtaiFirst)!

        var request:NSURLRequest = NSURLRequest(URL:url)
        self.wvXiangXChX_XiaoShDT.loadRequest(request)
        reload()
    }
    func reload(){
        ...
        println("reload")
        // Do any additional setup after loading the view.
//        var url:NSURL = NSURL(string:"127.0.0.1:10024/DayReport/cyc_rb/xsdt/xsdt.jsp")!
       var url:NSURL = NSURL(string:xiaoshoudongtaiFirst)!
